...
description: 'Apollo is a Windows-platform integration into the Mythic command-and-control framework'
source: 'MythicAgents/Apollo'
---

![logo](ApolloLandscape.svg)

## Summary

Apollo is open source, written in C#, and designed with training in mind to help students who take SpecterOps course offerings better understand how different attack techniques are implemented at a technical level.
