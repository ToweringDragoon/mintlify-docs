---
title: "Webshell"
description: "Basic profile to enable linked P2P agents to communicate with a Webshell agent. This also defines how the arachne agent's payload type container will reach out directly to a webshell agent if no ot..."
---
