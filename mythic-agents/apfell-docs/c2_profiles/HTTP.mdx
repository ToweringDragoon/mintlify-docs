---
title: "HTTP"
description: "The apfell agent uses a series of POST web requests to send responses for tasking and a series of GET requests to get tasking from the Mythic server."
---
