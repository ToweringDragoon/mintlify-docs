---
title: "jsimport_call"
description: "Call a function from within the JXA file that was imported with jsimport. This function call is appended to the end of the jsimport code and called via eval."
---
