---
title: "memfd"
description: "The memfd command loads a Linux executable file into memory (RAM) as an anonymous file using the [memfd_create](https://man7.org/linux/man-pages/man2/memfd_create.2.html) API call,"
---
