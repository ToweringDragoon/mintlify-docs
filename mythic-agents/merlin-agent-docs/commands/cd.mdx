---
title: "cd"
description: "The cd command is used to change the current working directory the Merlin agent is using."
---

<img src="../../images/merlin-horizontal.png?width=1000px" alt="Merlin Banner Logo" />
