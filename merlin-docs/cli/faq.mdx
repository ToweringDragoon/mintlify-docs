---
title: "CLI FAQ"
description: "Frequently asked questions about using the Merlin CLI"
icon: "circle-question"
---

- [How do I see help information for a command in the CLI?](#help)
- [How do I reconnect to the Merlin Server without restarting the CLI?](#reconnect)
