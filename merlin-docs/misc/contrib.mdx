---
title: "Contributing"
description: "Guidelines for contributing to the Merlin project"
icon: "handshake"
---
...
An excellent blog post by [Scott Mansfield](https://github.com/ScottMansfield) can be found
[on his blog](https://blog.sgmansfield.com/2016/06/working-with-forks-in-go/).
...
Merlin contributors can be viewed [here](https://github.com/Ne0nd0g/merlin/graphs/contributors).