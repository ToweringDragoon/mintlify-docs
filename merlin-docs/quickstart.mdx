---
title: "Quick Start"
description: "Get started with Merlin Server and Agent quickly"
icon: "rocket"
---

## Merlin Server

The quickest and recommended way is to download Merlin Server from the [releases](https://github.com/Ne0nd0g/merlin/releases)
...
The Microsoft Sysinternals [PsExec.exe](https://docs.microsoft.com/en-us/sysinternals/downloads/psexec) application
...
[Impacket's](https://github.com/CoreSecurity/impacket) `wmiexec.py` Python program is one way to remotely access a host.
