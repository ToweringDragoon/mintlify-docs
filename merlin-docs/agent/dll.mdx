---
title: "DLL Agent"
description: "Building and using the Merlin Agent as a Windows DLL"
icon: "puzzle-piece"
---
...
If the DLL is compiled on Windows, the [TDM-GCC](http://tdm-gcc.tdragon.net/download) 64bit compiler has proven to work well during testing.
