---
title: 'TAKEOVER-5'
description: 'Hierarchy Takeover via NTLM coercion and relay to AdminService on remote SMS Provider'
...
- [PREVENT-9: Enforce MFA for SMS Provider calls](../../../defense-techniques/PREVENT/PREVENT-9/prevent-9_description)
