---
title: 'TAKEOVER-7'
description: 'Hierarchy Takeover via NTLM coercion and relay to SMB between primary and passive site servers'
...
- [DETECT-5: Monitor group membership changes for SMS Admins](../../../defense-techniques/DETECT/DETECT-5/detect-5_description)
- [DETECT-5: Monitor group membership changes for RBAC_Admins table](../../../defense-techniques/DETECT/DETECT-6/detect-6_description)
