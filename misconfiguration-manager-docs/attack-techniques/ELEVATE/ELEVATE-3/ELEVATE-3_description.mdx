---
title: 'ELEVATE-3'
description: 'Coerce NTLM relay via automatic client push installation and AD System Discovery'
...
- Dirk-jan Mollema, [dnstool.py](https://github.com/dirkjanm/krbrelayx/dnstool.py)
