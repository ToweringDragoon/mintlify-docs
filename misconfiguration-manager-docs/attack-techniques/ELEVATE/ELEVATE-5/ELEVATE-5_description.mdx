---
title: 'ELEVATE-5'
description: 'Distribution Point Takeover via OSD Media Recovery'
...
- ELEVATE-4, [Distribution Point Takeover via PXE Boot Spoofing](../ELEVATE-4/ELEVATE-4_description)
