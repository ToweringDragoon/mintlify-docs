---
title: 'RECON-2'
description: 'Enumerate SCCM roles via SMB'
...
4. A resolved WSUS role can be a target for lateral movement or privilege escalation detailed in [ELEVATE-1](../../ELEVATE/ELEVATE-1/ELEVATE-1_description)
