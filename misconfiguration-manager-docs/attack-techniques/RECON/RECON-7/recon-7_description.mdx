---
title: 'RECON-7'
description: 'Enumerate SCCM site information via local files'
...
## Defensive IDs
- [DETECT-9: Monitor local object access for local SCCM logs and settings](../../../defense-techniques/DETECT/DETECT-9/detect-9_description)
