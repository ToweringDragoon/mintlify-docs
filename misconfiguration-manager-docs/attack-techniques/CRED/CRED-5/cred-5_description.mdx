---
title: 'CRED-5'
description: 'Dump credentials from the site database'
...
- [PREVENT-18: Use strong passwords for DBA accounts](../../../defense-techniques/PREVENT/PREVENT-18/prevent-18_description)
