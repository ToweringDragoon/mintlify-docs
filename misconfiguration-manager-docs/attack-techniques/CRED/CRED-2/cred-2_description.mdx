---
title: 'CRED-2'
description: 'Request computer policy and deobfuscate secrets'
...
- [PREVENT-8: Require PKI certificates for client authentation](../../../defense-techniques/PREVENT/PREVENT-8/prevent-8_description)
