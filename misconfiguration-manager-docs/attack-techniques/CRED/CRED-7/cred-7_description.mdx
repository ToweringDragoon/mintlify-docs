---
title: 'CRED-7'
description: 'Retrieve credentials via AdminService API'
...
## Impact
This technique provides an alternative to [CRED-5](../CRED-5/cred-5_description) that does not require direct interaction with the database.
