---
title: 'PREVENT-10'
description: 'Enforce the principle of least privilege for accounts'
...
This account is used to connect to computers and install the SCCM client software. Under certain conditions, attackers can coerce authentication from this account and potentially perform NTLM relay attacks ([ELEVATE-2](../../../attack-techniques/ELEVATE/ELEVATE-2/ELEVATE-2_description)).
...
**Note:** When this account joins computers to the domain, it will be become the owner of those computer objects, effectively having full control. Remove this ownership after joining the computer to the domain ([PREVENT-17](../PREVENT-17/prevent-17_description)).
...
- [PREVENT-3: Harden or disable network access accounts](../PREVENT-3/prevent-3_description)
- [PREVENT-4: Enable Enhanced HTTP](../PREVENT-4/prevent-4_description)
- [PREVENT-15: Disable and change passwords of legacy NAAs and collection variables/task sequence secrets in Active Directory](../PREVENT-15/prevent-15_description)
- [PREVENT-17: Remove Extended Rights assignment from accounts that do not require it](../PREVENT-17/prevent-17_description)
- [PREVENT-22: Do not manage assets in two or more segmented forests, domains, networks, or security tiers](../PREVENT-22/prevent-22_description)

## Associated Offensive IDs
- [CRED-1: Retrieve secrets from PXE boot media](../../../attack-techniques/CRED/CRED-1/cred-1_description)
- [CRED-2: Request and deobfuscate machine policy to retrieve credential material](../../../attack-techniques/CRED/CRED-2/cred-2_description)
- [CRED-3: Dump currently deployed credentials via WMI](../../../attack-techniques/CRED/CRED-3/cred-3_description)
- [CRED-4: Retrieve legacy network access account (NAA) credentials from the CIM Repository](../../../attack-techniques/CRED/CRED-4/cred-4_description)
- [CRED-5: Dump SCCM credentials from site database](../../../attack-techniques/CRED/CRED-5/cred-5_description)
