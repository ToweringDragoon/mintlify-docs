---
title: 'PREVENT-3'
description: 'Harden or disable network access accounts'
...
- Managing clients in untrusted domains and cross-forest trusts (don't do this! see [PREVENT-22](../PREVENT-22/prevent-22_description))
...
<Frame caption="Figure 1 - Network access account configuration">
  <img src="./prevent-3_naa-disable.png" alt="Network access account configuration" />
</Frame>

**NOTE:** When disabling or changing the NAA, it is paramount to disable the old account in Active Directory. This is explained in [PREVENT-15](../prevent-15/prevent-15_description).

## Linked Defensive IDs
- [PREVENT-4: Enable Enhanced HTTP](../PREVENT-4/prevent-4_description)
- [PREVENT-8: Require PKI certificates for client authentation](../PREVENT-8/prevent-8_description)
- [PREVENT-15: Disable legacy network access accounts in active directory](../PREVENT-15/prevent-15_description)
...
- [CRED-2: Request machine policy and deobfuscate secrets](../../../attack-techniques/CRED/CRED-2/cred-2_description)
- [CRED-3: Dump currently deployed secrets via WMI](../../../attack-techniques/CRED/CRED-3/cred-3_description)
- [CRED-4: Retrieve legacy secrets from the CIM repository](../../../attack-techniques/CRED/CRED-4/cred-4_description)
