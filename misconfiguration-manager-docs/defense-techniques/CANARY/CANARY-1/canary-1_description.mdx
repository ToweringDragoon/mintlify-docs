---
title: 'CANARY-1'
description: 'Configure an appropriately-privileged NAA with interactive logon restricted'
...
- [PREVENT-3: Harden or disable network access accounts](../../PREVENT/PREVENT-3/prevent-3_description)
- [PREVENT-10: Enforce the principle of least privilege for accounts](../../PREVENT/PREVENT-10/prevent-10_description)
