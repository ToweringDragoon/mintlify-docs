---
title: 'Nemesis'
description: 'Offensive file enrichment pipeline'
---

<div style={{ textAlign: 'center', marginBottom: '30px' }}>
  <img className="block dark:hidden" src="images/nemesis-light.png" alt="Nemesis Logo" />
  <img className="hidden dark:block" src="images/nemesis-dark.png" alt="Nemesis Logo" />
</div>
