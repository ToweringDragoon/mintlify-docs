...
Install the PyPi package via pip `pip3 install mythic` . The current mythic package is version `0.1.0rc2`. The code for it is public - [https://github.com/MythicMeta/Mythic\_Scripting](https://github.com/MythicMeta/Mythic_Scripting)
