...
* [Uploading](/version-2.3/customizing/hooking-features/action-upload) Files

* How [agent messages](/version-2.3/customizing/c2-related-development/c2-profile-code/agent-side-coding/agent-message-format) are formatted

* How to perform [initial checkins](/version-2.3/customizing/c2-related-development/c2-profile-code/agent-side-coding/initial-checkin) and do encrypted [key exchanges](/version-2.3/customizing/c2-related-development/c2-profile-code/agent-side-coding/initial-checkin#encrypted-key-exchange-checkins)

* How to [Get Tasking](/version-2.3/customizing/c2-related-development/c2-profile-code/agent-side-coding/action_get_tasking)

* How to [Post Responses](/version-2.3/customizing/c2-related-development/c2-profile-code/agent-side-coding/action-post_response)
