...
In general, there's a few steps that happen for this process (visually this can be found on the [Message Flow](/version-2.3/message-flow#downloading-a-file-from-agent-greater-than-mythic) page):
