---
title: "Translation Containers"
description: "If you want to have a different form of communication between Mythic and your agent than the specific JSON messages that Mythic uses, then you'll need a translation container."
---
...
<Card
   title="These examples can be found at the MythicMeta organization on GitHub:"
   icon="github"
   href="https://github.com/MythicMeta/ExampleContainers/tree/main/Payload_Type"
   iconType="solid"
   horizontal
/>
...
Just like with Payload Types, a Translation container doesn't have to be a Dockerized instance. To turn any VM into a translation container just follow the general flow at [Turning a VM into a Mythic container](https://docs.mythic-c2.net/version-2.3/customizing/payload-type-development#turning-a-vm-into-a-mythic-container)
