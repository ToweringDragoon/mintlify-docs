...
**CommandBase** defines the metadata about the command as well as any pre-processing functionality that takes place before the final command is ready for the agent to process. This class includes the `create_go_tasking` ([Create\_Tasking](https://docs.mythic-c2.net/version-2.3/customizing/payload-type-development/create_tasking)) and `process_response` ([Process Response](https://docs.mythic-c2.net/version-2.3/customizing/payload-type-development/process-response)) functions.

\*\*\*\*[**TaskArguments**](https://docs.mythic-c2.net/version-2.3/customizing/payload-type-development/commands#taskarguments) does two things:
...
If you're curious how this all plays out in a diagram, you can find one here: [#operator-submits-tasking](https://docs.mythic-c2.net/version-2.3/message-flow#operator-submits-tasking).
...
- `dynamic_query_function` - More information can be found [here](https://docs.mythic-c2.net/version-2.3/customizing/payload-type-development/dynamic-parameter-values), but you can provide a function here for ONLY parameters of type ChooseOne or ChooseMultiple where you dynamically generate the array of choices you want to provide the user when they try to issue a task of this type.
