...
See the [C2 Related Development section](/version-2.3/customizing/c2-related-development/c2-profile-code/agent-side-coding/socks) for more SOCKS specific message details.
