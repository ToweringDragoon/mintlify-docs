...
* Solidified P2P spec - [Delegates](/version-2.3/customizing/c2-related-development/c2-profile-code/agent-side-coding/delegates) and [P2P Connections](/version-2.3/customizing/hooking-features/action-p2p_info)
...
* Updating to using a PyPi package instead of local files means that you need to adjust the imports for all of the Python files for your agents. It's nothing too crazy, but you'll update like so: [Payload Type Info](/version-2.3/customizing/payload-type-development/payload-type-info#building)
