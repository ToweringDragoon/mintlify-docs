...
If you want to look into all the new features available to you as a payload developer from an agent perspective, check out [Agents 2.3 -> 3.0](/updating/mythic-2.3-greater-than-3.0-updates/agents-2.3-greater-than-3.0). The rest of this page is for higher-level updates and UI changes.
