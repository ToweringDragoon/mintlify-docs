...
* [Delegates](/Mythic_docs/customizing/payload-type-development/create_tasking/agent-side-coding/delegates)

* [Socks](/Mythic_docs/customizing/hooking-features/socks)

* [Rpfwd](/Mythic_docs/customizing/hooking-features/rpfwd)

* [Interactive](/Mythic_docs/customizing/hooking-features/interactive-tasking)

* [Edges](/Mythic_docs/customizing/hooking-features/linking-agents/action-p2p_info)

* [Alerts](/Mythic_docs/customizing/hooking-features/alerts)

* [Upload](/Mythic_docs/customizing/hooking-features/action-upload)

* [Download](/Mythic_docs/customizing/hooking-features/download)

* [Callback Tokens](/Mythic_docs/customizing/hooking-features/tokens)

* [Tokens](/Mythic_docs/customizing/hooking-features/tokens)

* [Keylogs](/Mythic_docs/customizing/hooking-features/keylog)

* [ProcessResponse](/Mythic_docs/customizing/payload-type-development/process-response)

* [Commands](/Mythic_docs/customizing/hooking-features/commands)

* [Processes](/Mythic_docs/customizing/hooking-features/process_list)

* [Artifacts](/Mythic_docs/customizing/hooking-features/artifacts)

* [Credentials](/Mythic_docs/customizing/hooking-features/credentials)

* RemovedFiles

* [FileBrowser](/Mythic_docs/customizing/hooking-features/file-browser)
