...
[Previous4. Submitting Responses](/Mythic_docs/customizing/payload-type-development/create_tasking/agent-side-coding/action-post_response)[Next6. Reverse Port Forward](/Mythic_docs/customizing/payload-type-development/create_tasking/agent-side-coding/rpfwd)
