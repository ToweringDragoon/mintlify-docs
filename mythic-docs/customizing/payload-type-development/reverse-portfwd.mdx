...
See the [C2 Related Development section](/Mythic_docs/customizing/payload-type-development/create_tasking/agent-side-coding/rpfwd) for more RPFWD specific message details.
