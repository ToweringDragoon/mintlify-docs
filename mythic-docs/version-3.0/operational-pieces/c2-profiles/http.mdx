---
title: "HTTP"
description: 'The "HTTP" C2 profile speaks the exact same protocol as the Mythic server itself.'
---

## What is it?

All other C2 profiles will translate between their own special sauce back to this format. This profile has a docker container as well that you can start that uses a simple JSON configuration to redirect traffic on another port (with potentially different SSL configurations) to the main Mythic server.
...
<Frame caption="Default C2 Profile parameters">
  <img src="/images/version-3.0/image-25.avif"/>
</Frame>
