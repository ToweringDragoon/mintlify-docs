...
descritpion: "All C2 profiles are backed by a Docker container or intermediary layer of some sort."
---
...
There are a few things needed to make a C2 container. For reference on general code structure options, check out [1. Payload Type Development](/version-3.0/customizing/payload-type-development). The general structure is the same for Payload Types, C2 Profiles, and Translation containers.
...
<Frame>
    <img src="/images/version-3.0/image-53.avif"/>
</Frame>
