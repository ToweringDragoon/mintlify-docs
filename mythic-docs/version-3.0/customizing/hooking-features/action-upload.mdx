...
In general, there's a few steps that happen for this process (this can be seen visually on the [Message Flow](/version-3.0/message-flow#file-uploads-from-mythic-greater-than-agent) page):
