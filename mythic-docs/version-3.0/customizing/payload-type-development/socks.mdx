---
title: "13. SOCKS"
description: "See the [C2 Related Development section](/version-3.0/customizing/payload-type-development/create_tasking/agent-side-coding/socks) for more SOCKS specific message details."
---
