...
<Frame>
    <img src="/images/version-3.0/image-52.avif"/>
</Frame>
...
For information on the message format, check out [Interactive Tasking](https://docs.mythic-c2.net/version-3.0/customizing/payload-type-development/create_tasking/agent-side-coding/8.-interactive-tasking).
