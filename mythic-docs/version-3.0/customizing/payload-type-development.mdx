---
title: "1. Payload Type Development"
...
<Frame caption="mythic_admin stopped the c2 profile container">
  <img src="/images/version-3.0/image-44.webp"/>
</Frame>
...
Check out the [Payload Type](https://docs.mythic-c2.net/version-3.0/customizing/payload-type-development/payload-type-info) page for information on what the various components in the agent definition means and how to start customizing how your agent looks within Mythic.
