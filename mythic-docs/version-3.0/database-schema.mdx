...
description: "The database schema describes the current state of Mythic within the `mythic_postgres` Docker container."
---
...
<Frame caption="Hasura Console">
  <img src="/images/version-3.0/image-28.webp"/>
</Frame>
...
<Frame caption="Hasura Console">
  <img src="/images/version-3.0/image-29.webp"/>
</Frame>

<Frame caption="Hasura Console">
  <img src="/images/version-3.0/image-30.webp"/>
</Frame>
